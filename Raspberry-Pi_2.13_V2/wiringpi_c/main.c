...
// 						 EPD_Dis_Part_myself(32,72,Num[Miao_L],  //x-A,y-A,DATA-A
// 											32,104,Num[Miao_H],         //x-B,y-B,DATA-B
// 											32,144,gImage_numdot,      //x-C,y-C,DATA-C
// 											32,186,Num[Fen_L],         //x-D,y-D,DATA-D
// 											32,218,Num[Fen_H],32,64);	 //x-E,y-E,DATA-E,Resolution 32*64 
//                          delay(100);
